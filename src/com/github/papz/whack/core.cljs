(ns com.github.papz.whack.core
  (:require-macros [hiccups.core :as hiccups :refer [html]])
  (:require [com.github.papz.whack.glogger :as goog-log]
...
(defn binary-problem-view
  ...
  [id problem]
  ;; (goog-log/wack-logger (str "bin gen is " (gen-binary-solution x)))
  ;; Todo: destructuring
...
(defn user-turn
  ""
  [e]
;;  (goog-log/wack-logger (str "I have you now 999" e))
...
(defn update-game
  ""
  [e]
 ;; (goog-log/wack-logger (str "You clicked" (.getAttribute (aget e "target") "data-game-fn")))
...
;;  (goog-log/wack-logger "my own logger 888")
...
;;                  (fn [e]
;;                    (goog-log/wack-logger (str "You clicked" (.-target e) "-" (.-data e) "-" (.-idx e) "-"))
;;                    (goog-log/wack-logger (str "You clicked" (aget e "target" "id"))))))
...
(defn main!
  ...
  ;;(goog-log/wack-logger (str "dom should appear" (dom/getElement "app")))
  ;;(goog-log/wack-logger (str "2222" (gen-binary-problem 1 [1 1 1 1 1 1 1])))
 ;; (goog-log/wack-logger (str "3333 key is" (:key (generate-problem 1))))
 ;; (goog-log/wack-logger (str "3333 key is" (keys (generate-problem 1))))
  ;;(goog-log/wack-logger (str "5555 key is" (get (generate-problem 1) 52)))
  ;; (goog-log/wack-logger (str "5555 prob dec is" (:problem-decimal (get (generate-problem 1) 52)))))
